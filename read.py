...
def generateForm(question):
	...
	f.write("<!DOCTYPE html>\n<html>\n<body>\n<form method='POST' action = 'http://0.0.0.0:5000/results/'>")
	f.write(question["question"]+"\n<br>")
	for o in question["options"]:
		f.write('<input type="checkbox" name="' + question["variable"] + '" value="' + o + '">' + o + '<br>')
	f.write('<input type="submit" value="Submit"></form></body></html>')
	f.close()
	return "layouts/test.html"
#	global schedule
#	global questions
#	f = open("test.html", "w")
